...
public class Proyecto_final {
    ...
    // ─── Método helper: muestra opciones y re-pregunta si el usuario abre la mochila ───
    private int pedirOpcion(String... opciones) {
        int op;
        do {
    ...
    public void juego(ImageIcon img) {
        while (juegoActivo) {
            ...
            int opcion = pedirOpcion(
                    "1. Moverse por la parte izquierda del arbol marcado ‍🚶🏼‍♂️️",
                    "2. Moverse por la parte derecha del arbol marcado 🚶🏼‍♂️‍➡️"
            );
            ...
            switch (opcion) {
                ...
                case 1:
                    ...
                    opcion = pedirOpcion(
                            "1. Subirte al árbol más cercano 🏃🏼‍♂️‍➡️⬆️🌲",
                            "2. Moverte más rápido para pasar el camino 🏃🏼‍♂️️💨"
                    );
                        ...
                        case 1:
                            ...
                            switch (opcion) {
                                ...
                                case 2:
                                    ...
                                    opcion = pedirOpcion(
                                            "1. Ir por donde el grupo 👨🏿‍👩🏻‍👧🏾‍👦🏽",
                                            "2. Ir en dirección contraria al grupo ❌👨🏿‍👩🏻‍👧🏾‍👦🏽"
                                    );
                                    ...
                                    switch (opcion) {
                                        case 1:
                                            ...
                                            reproducirEfecto.reproducir("going-on-a-forest-road-gravel-and-grass-6404 (mp3cut.net).wav");
                                            opcion = pedirOpcion(
                                                    "1. Pruebas a abrir las jaulas ⛓️‍💥",
                                                    "2. Decides continuar tu camino ➡️🚶🏼‍♂️‍➡️"
                                            );
                                        ...
                                        case 2:
                                            ...
                                            reproducirEfecto.reproducir("going-on-a-forest-road-gravel-and-grass-6404 (mp3cut.net).wav");
                                            opcion = pedirOpcion("1. Dialogas 💬", "2. Corres 🏃🏼‍♂️‍➡️");
                        ...
                        case 2:
                            ...
                            switch (opcion) {
                                case 1:
                                    ...
                                    System.out.println("¿Qué decides hacer?");
                                    opcion = pedirOpcion(
                                            "1. Mirar los alrededores 🔎",
                                            "2. Entrar a la cabaña 🚶🏼‍♂️‍➡️🛖"
                                    );
                                    ...
                                    switch (opcion) {
                                        case 1:
                                            ...
                                            opcion = pedirOpcion("1. Comprobar su origen 🧏🏼", "2. Esconderse 🐢");
                ...
                case 2:
                    ...
                    System.out.println("¿Qué decides hacer?");
                    opcion = pedirOpcion(
                            "1. Dirigirse hacia la figura 🚶🏼‍♂️‍➡️🗿",
                        ...
                        case 1:
                            ...
                            switch (opcion) {
                                case 1:
                                    ...
                                    opcion = pedirOpcion("1. Dialogar 💬", "2. Correr 🏃🏼‍♂️‍➡️");
                                ...
                                case 2:
                                    ...
                                    switch (opcion) {
                                        case 1:
                                            ...
                                            opcion = pedirOpcion(
                                                    "1. Pasar la noche en la cabaña 🌙🛖",
                                                    "2. Salir de noche 🌙🚶🏼‍♂️‍➡️"
                                            );
                        ...
                        case 2:
                            ...
                            switch (opcion) {
                                case 1:
                                    ...
                                    switch (opcion) {
                                        ...
                                        case 2:
                                            ...
                                            System.out.println("¿Qué haréis?");
                                            opcion = pedirOpcion(
                                                    "1. Pasar la noche en la cabaña 🌙➡️☀️",
                                                    "2. Salir de noche 🌙🚶🏼‍♂️‍➡️"
                                            );
                                ...
                                case 2:
                                    ...
                                    opcion = pedirOpcion("1. Golpear antes de aproximarse", "2. Esperar a que se aproxime");

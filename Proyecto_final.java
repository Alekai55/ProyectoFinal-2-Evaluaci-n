            ...
            if (opcion == 1) {
                ...
                if (opcion == 1) {
                    ...
                    if (opcion == 1) {
                        ...
                        while (opcion != 1 && opcion != 2) {
                            System.out.println("Decidiste no bajar a por las llaves");
                            System.out.println("ecides esperar a que se vayan. Bajas cautelosamente del árbol y guardas las llaves en el bolsillo de tu chaqueta. Pesan bastante y tienen formas extrañas. Están manchadas de algo aceitoso ");
                            System.out.println("¿Qué camino elegirias?");
                            System.out.println("1. Ir por donde el grupo 👨🏿‍👩🏻‍👧🏾‍👦🏽");
                            System.out.println("2. Ir en dirección contraria al grupo ❌👨🏿‍👩🏻‍👧🏾‍👦🏽");
                            opcion = sc.nextInt();

...
public class VentanaLogin extends JFrame {
    // Declaramos las variables aquí arriba para que "toda la clase" las vea y también usarlas en el método de interacción
    // porque si no, como las demás las creo en iniciarcomponentes(privado), no las tengo
    ...
    private void iniciarComponentes() {
        ...
        // Las mono-espaciadas van bien para escribir

        // Declaración y configuración de texto "título"
        titulo = new JLabel("Inicio sesión de usuario");
        titulo.setBounds(110, 10, 200, 20);
        titulo.setFont(new Font("Arial", Font.BOLD, 15));
        titulo.setForeground(Color.decode("#08E576")); // Color neón como en la web
        add(titulo);

        // Declaración y configuración de texto "usuario"
        ...
        // Declaración y configuración de campo de texto para el nombre
        ...
        // Declaración y configuración de texto "contraseña"
        ...
        // Declaración y configuración de botón para iniciar sesión

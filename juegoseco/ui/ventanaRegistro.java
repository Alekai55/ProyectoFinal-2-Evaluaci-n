...
public class ventanaRegistro extends JFrame{
    //Creamos las variables private así nadie puede utilizarlas
    //Sin static, Porque static significa que la variable pertenece a la "plantilla" de la clase en general, no a la ventana específica.
    // Si se abriesen dos ventanas de registro a la vez, compartirían el mismo nombre de usuario.
    private String username = "";
    private String pwd = "";
    // Atributo de interfaz cerrado: Usamos 'private' para asegurar que el icono
    // de la ventana de registro pertenezca únicamente a esta clase, manteniendo el código blindado.
